...
class InputManager:
    ...
    def input_index(self, start: int, end: int):
        ...
        :param start: smallest index
        :param end: largest index
        :return: valid index
        """
        if start == end:
            ...
            print(self.messages["index_input"].format(start, end))
            entry = input()
            ...
            try:
                ...
                print(self.messages["wrong_index"].format(start, end))
                raise ImmediateReturn
    ...
    def input_index_range(self, start: int, end: int):
        ...
        print(self.messages["index_range_input"].format(start, end))
        ...
        try:
            ...
            print(self.messages["wrong_index_range"].format(start, end))
            raise ImmediateReturn
